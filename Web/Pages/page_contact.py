...
from Web.Locators.locator_contact import *
...
class Contact_Detail:
    def __init__(self, driver: WebDriver):
        ...
        self.contact_button = Contact.CONTACT_BUTTON
        self.emailID = Contact.EMAIL
        self.nameID = Contact.NAME
        self.messageID = Contact.MESSAGE_FIELD
        self.Send_messageXPath = Contact.SEND_MESSAGE
