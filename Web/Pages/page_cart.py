...
from Web.Locators.locator_add_to_cart import *
...
class cart_steps():
    def __init__(self, driver: WebDriver):
        ...
        self.home_button = cart_ID.HOME_BUTTON
        self.categories_button = cart_ID.CATEGORIES
        self.phone_button = cart_ID.PHONE
        self.samsung_galaxy = cart_ID.SAMSUNG_GALAXY
        self.add_to_cart = cart_ID.ADD_TO_CART
